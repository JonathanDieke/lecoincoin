                ...
                <tr class="h-100">
                    ...
                    <td class="d-sm-flex justify-content-around h-100">
                        ...
                        <a type="button" class="btn btn-danger"
                           onclick="confirm('${message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}') ? document.querySelector('.form-delete-annonce-${annonce.id}').submit() : null"><i
